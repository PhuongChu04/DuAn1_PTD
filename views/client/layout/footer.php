<footer class="footer footer_type_1">
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="sitemap d-flex">
        <div class="w-50 d-none d-lg-block">
          <img loading="lazy" src="client/images/nav-bg.jpg" alt="Site map" class="sitemap__bg">
        ...
        <div class="product-single">
              ...
              <div class="swiper-container js-swiper-slider"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="client/images/products/quickview_1.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="client/images/products/quickview_2.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="client/images/products/quickview_3.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="client/images/products/quickview_4.jpg" alt="">
                  </div>
                </div>
          ...
          <div class="product-single__detail">
            ...
            <div class="product-single__addtolinks">
              ...
              <script src="client/js/details-disclosure.js" defer="defer"></script>
              <script src="client/js/share.js" defer="defer"></script>
            </div>
        ...
        <div class="row p-0 m-0">
          <div class="col-md-6 p-0 d-none d-md-block">
            <div class="newsletter-popup__bg h-100 w-100">
              <img loading="lazy" src="client/images/newsletter-popup.jpg" class="h-100 w-100 object-fit-cover d-block" alt="">
            </div>
          </div>
  ...
  <script src="client/js/plugins/jquery.min.js"></script>
  <script src="client/js/plugins/bootstrap.bundle.min.js"></script>
  <script src="client/js/plugins/bootstrap-slider.min.js"></script>
  <!-- <script client/src="js/plugins/jquery.waypoints.min.js"></script> -->
  <!-- <script client/src="js/plugins/sticky.min.js"></script> -->
  <script src="client/js/plugins/swiper.min.js"></script>
  <script src="client/js/plugins/countdown.js"></script>
